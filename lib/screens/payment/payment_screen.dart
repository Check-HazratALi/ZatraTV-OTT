...
class PaymentScreen extends StatelessWidget {
  PaymentScreen({super.key}) {
    ...
    if (args is List && args.isNotEmpty) {
      if (args[0] is SubscriptionPlanModel) {
        ...
        paymentCont.rentPrice.value = (args[2] as VideoPlayerModel)
            .discountedPrice
            .validate()
            .toDouble();
  ...
  void removeAppliedCoupon() {
    ...
    paymentCont.couponListClassCont.appliedCouponData.value.isCouponApplied =
        false;
    paymentCont.couponListClassCont.appliedCouponData(CouponDataModel());
    subscriptionCont.calculateTotalPrice(
      appliedCouponData:
      ...
      child: AppScaffold(
          ...
          return AnimatedScrollView(
            ...
            children: [
              ...
              if (!paymentCont.isRent.value &&
                  (paymentCont.couponListClassCont.searchCont.text.isNotEmpty ||
                      paymentCont
                          .couponListClassCont
                          .couponList
                          .isNotEmpty)) ...[
                      ...
                      Get.to(
                        ...
                        if (value != null) {
                          if (value is CouponDataModel) {
                            paymentCont.couponListClassCont.appliedCouponData(
                              value,
                            );
                            subscriptionCont.calculateTotalPrice(
                              appliedCouponData: paymentCont
                ...
                Obx(() {
                  return AppTextField(
                      ...
                      suffixIcon: Row(
                        ...
                        children: [
                          paymentCont.couponListClassCont.isTyping.value
                              ? GestureDetector(
                                  onTap: () {
                                    paymentCont.couponListClassCont
                                        .clearSearchField(
                                          context,
                                          selectedPlanId: paymentCont
                                              .selectPlan
                                              .value
                                              .planId
                                              .toString(),
                    ...
                    onFieldSubmitted: (value) {
                      paymentCont.couponListClassCont.onSearch(
                        searchVal: value,
                        selectedPlanId: paymentCont.selectPlan.value.planId
                            .toString(),
                      );
                    },
                  );
                    ...
                    return SnapHelperWidget(
                      ...
                      onSuccess: (data) {
                        if (paymentCont
                                ...
                                .couponList
                                .isEmpty &&
                            paymentCont.couponListClassCont.isLoading.isFalse) {
                          return NoDataWidget(
                          ...
                          return AnimatedListView(
                            ...
                            itemBuilder: (context, index) {
                              CouponDataModel couponData = paymentCont
                                  .couponListClassCont
                                  .couponList[index];
                              final isLast =
                                  index ==
                                  paymentCont.couponListClassCont.couponList
                                          .take(2)
                                          .length -
                                      1;
                              ...
                              if (paymentCont
                                      ...
                                      .code ==
                                  couponData.code) {
                                couponData.isCouponApplied = paymentCont
                                    .couponListClassCont
                                    .appliedCouponData
                                    .value
                                    .isCouponApplied;
              ...
              Obx(() {
                return SnapHelperWidget(
                  ...
                  loadingWidget: paymentCont.isPaymentLoading.isTrue
                      ...
                      : Offstage(),
                  onSuccess: (data) {
                    if (paymentCont.originalPaymentList.isEmpty &&
                        paymentCont.isPaymentLoading.isFalse) {
                      return NoDataWidget(
                        titleTextStyle: secondaryTextStyle(
                          color: white,
                          size: 16,
                        ...
                        imageWidget: const EmptyStateWidget(),
                        onRetry: () {
                          paymentCont.getPayment(
                            showLoader: true,
                          ); // Retry fetching payment methods
                        },
                      ).center();
                    } else {
                      return AnimatedListView(
                        ...
                        itemBuilder: (context, index) {
                          return PaymentCardComponent(
                            paymentDetails: paymentCont
                                .originalPaymentList[index], // Payment method details
        ...
        bottomNavBar: Obx(
          () => PriceComponent(
            ...
            buttonColor:
                paymentCont.selectPayment.value.title?.isNotEmpty ?? false
                ? appColorPrimary
                : lightBtnColor,
            onCallBack: () {
              if (isLoggedIn.value) {
                  ...
                  if (paymentCont.isLoading.isFalse) {
                    if (paymentCont.isRent.value) {
                      ...
                      VideoPlayerModel video =
                          paymentCont.videoPlayerModel.value;

                      var planId = video.id;
                      var totalAmount = video.discountedPrice.toDouble();
                      var userId = loginUserData.value.id;
                      ...
                      int planId = subscriptionCont.selectPlan.value.planId;
                      int userId = loginUserData.value.id;
