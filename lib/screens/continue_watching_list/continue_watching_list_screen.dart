...
class ContinueWatchingListScreen extends StatelessWidget {
  ...
  final ContinueWatchingListController continueWatchingListCont = Get.put(
    ContinueWatchingListController(),
  );
          ...
          RefreshIndicator(
            child: Obx(
              () => SnapHelperWidget(
                ...
                initialData: cachedContinueWatchList.isNotEmpty
                    ? cachedContinueWatchList
                    : null,
                            ...
                            return AnimatedScrollView(
                              ...
                              children: [
                                AnimatedWrap(
                                  ...
                                  itemCount: continueWatchingListCont
                              ...
                              onNextPage: () async {
                                if (!continueWatchingListCont
                                    .isLastPage
                                    .value) {
                                  continueWatchingListCont.page(
                                    continueWatchingListCont.page.value + 1,
                                  );
                                  continueWatchingListCont
                                      .getContinueWatchMovieList();
                                }
                              },
                              onSwipeRefresh: () async {
                                continueWatchingListCont.page(1);
                                return await continueWatchingListCont
                                    .getContinueWatchMovieList(
                                      showLoader: false,
                                    );
                              },
  ...
  Future<void> handleRemoveFromContinueWatchClick(
    List<VideoPlayerModel> continueWatchingList,
    int index,
      ...
      BackdropFilter(
        ...
        child: RemoveContinueWatchingComponent(
          onRemoveTap: () {
            ...
            CoreServiceApis.removeContinueWatching(
                  continueWatchingId: continueWatchingList[index].id,
                )
                .then((value) {
