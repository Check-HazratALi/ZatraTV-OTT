...
class SubscriptionHistoryScreen extends StatelessWidget {
  ...
  final SubscriptionHistoryController controller = Get.put(
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        6.height.visible(
                          currentSubscription.value.name.isNotEmpty,
                        ),
                        planRows(
                        ...
                        6.height.visible(
                          currentSubscription.value.type.isNotEmpty,
                        ),
                        planRows(
                        ...
                        6.height.visible(
                          currentSubscription.value.couponDiscount > 0,
                        ),
                        ...
                        if (currentSubscription.value.discountAmount > 0)
                          planRows(
                            ...
                            value: currentSubscription.value.discountAmount
                                .toString(),
                            isAmount: true,
                          ).paddingTop(6),
                        ...
                        if (currentSubscription.value.taxAmount > 0)
                          planRows(
                            ...
                            value: currentSubscription.value.taxAmount
                                .toString(),
                            isAmount: true,
                          ),
                        12.height,
                        planRows(
                          ...
                          value: currentSubscription.value.totalAmount
                              .toString(),
                          isAmount: true,
                        ),
                        12.height,
